...
public class RegistroController {
    ...
    public void initialize() {
        ...
        eyeCloseImage = new Image(getClass().getResourceAsStream("/es/jualas/primer_registro/images/eye_close.png"));
        eyeOpenImage = new Image(getClass().getResourceAsStream("/es/jualas/primer_registro/images/eye_open.png"));
